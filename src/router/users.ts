...
userRouter.put("/", async(req,res) => {
    ...
    if (nom!==null) {
        const monResultat = {nom, prenom , email, ismasculin, filiere, mention, etudes, password, qidinfo1, qidinfo2, qidinfo3, qidmeca1, qidmeca2, qidmeca3, qidfluides1, qidfluides2, qidfluides3, qidthermo1, qidthermo2, qidthermo3, qidplasmas1, qidplasmas2, qidplasmas3, qidelec1, qidelec2, qidelec3}
